...
# Based on https://github.com/unicode-org/cldr/blob/master/common/supplemental/windowsZones.xml rebuild
# by running this file directly (rev: 2018h and 2018i).
_windows_to_iana = {
    ...
    with urlopen('https://raw.githubusercontent.com/unicode-org/cldr/master/common/supplemental/windowsZones.xml') as conn:
        ...
        for zone in root.findall('.//mapZone'):
            if zone.get('territory') == '001':
                result[zone.get('other')] = zone.get('type')
